...
describe('API ENDPOINT TESTING', () => {
  ...
  it('POST Booking', (done) => {
    ...
    const dataSample = {
        ...
        duration: 2,
        bookingStartDate: "2020-07-20",
        bookingEndDate: "2020-07-30",
        firstName: 'Helsa',
        lastName: 'Nanda',
        email: 'helsanda@gmail.com',
        phoneNumber: '08114555423',
        accountHolder: 'Helsa',
        bankFrom: 'BNI',
    };
    chai.request(app).post('/api/v1/member/booking-page')
    .set('Content-Type', 'application/x-www-form-urldecoded')
    ...
    .end((err, res) => {
      ...
      expect(res.body.data).to.have.all.keys('payments', '_id', 'invoice', 'bookingStartDate', 'bookingEndDate', 'total', 'itemId', 'memberId', '__v')
